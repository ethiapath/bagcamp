      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 mb-4">
              BAGCAMP
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/artist/signup" className="text-gray-400 hover:text-white transition">Join as Artist</Link></li>
              <li><Link href="/artist/resources" className="text-gray-400 hover:text-white transition">Artist Resources</Link></li>
              <li><Link href="/artist/tools" className="text-gray-400 hover:text-white transition">Selling Tools</Link></li>
              <li><Link href="/artist/stats" className="text-gray-400 hover:text-white transition">Stats & Analytics</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-900 mt-12 pt-8">
          <p className="text-gray-500 text-sm text-center">
            © {new Date().getFullYear()} Bagcamp. Created with love by DJ Bag Lady. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
